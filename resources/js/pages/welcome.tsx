                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-center shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-4 text-4xl font-bold">Counter App</h1>
                            <div className="mb-8">
                                ...
                                <button
                                    ...
                                    className="inline-block rounded-sm border border-[#f53003] bg-[#f53003] px-8 py-3 text-lg font-medium leading-normal text-white hover:bg-[#e02d00] hover:border-[#e02d00] dark:border-[#FF4433] dark:bg-[#FF4433] dark:hover:bg-[#FF2211] dark:hover:border-[#FF2211] transition-colors"
                                >
                                    Increment Counter
                                </button>
                            </div>
                            <p className="text-lg text-[#706f6c] dark:text-[#A1A09A]">
                                Click the button to increment the counter. The value is persisted in the database!
                            </p>
